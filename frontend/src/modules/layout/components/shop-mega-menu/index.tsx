...
const ShopMegaMenu = ({
  ...
  return (
    <div
      ...
      className={`absolute left-0 top-[calc(100%+0rem)] z-20 w-[min(1440px,92vw)] max-w-[1440px] rounded-br-xl rounded-bl-xl border border-gray-200/70 bg-white  transition-all duration-200 ease-out ${
        isOpen
      ...
      onKeyDown={onKeyDown}
    >
      <div className="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-[repeat(6,minmax(0,1fr))]">
